    ...
    <>
      ...
      <section style={{ background: '#f9f9f9', padding: '60px 20px', borderTop: '1px solid #eee' }}>
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 13, color: '#444', lineHeight: 1.8, marginBottom: 16 }}>
            IVT MEDIA GROUP (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;) is committed to protecting your personal information. This Privacy Policy explains how we collect, use, and safeguard your information when you interact with our services.
          </p>
          <p style={{ fontSize: 13, color: '#444', lineHeight: 1.8, marginBottom: 16 }}>
          ...
          <p style={{ fontSize: 13, color: '#444', lineHeight: 1.8, marginBottom: 16 }}>
            <strong>How We Use Your Information:</strong> We use the information we collect to communicate with you about Iron Vault Token, IVT MEDIA GROUP services, promotions, and updates. We may contact you via phone, email, or text message based on your consent.
          </p>
          <p style={{ fontSize: 13, color: '#444', lineHeight: 1.8, marginBottom: 16 }}>
            <strong>Text Messaging:</strong> By opting in, you consent to receive text messages from IVT MEDIA GROUP. Message and data rates may apply. Message frequency varies. Reply STOP to opt out at any time. Reply HELP for assistance.
          </p>
          <p style={{ fontSize: 13, color: '#444', lineHeight: 1.8, marginBottom: 16 }}>
      ...
      <section style={{ background: '#fff', padding: '60px 20px', borderTop: '1px solid #eee' }}>
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 13, color: '#444', lineHeight: 1.8, marginBottom: 16 }}>
            By submitting this form and opting in to communications from IVT MEDIA GROUP, you agree to the following terms.
          </p>
          <p style={{ fontSize: 13, color: '#444', lineHeight: 1.8, marginBottom: 16 }}>
          ...
          <p style={{ fontSize: 13, color: '#444', lineHeight: 1.8, marginBottom: 16 }}>
            <strong>No Guarantees:</strong> IVT MEDIA GROUP makes no guarantees regarding the future value of Iron Vault Token, returns on investment, or the timeline for any exchange listings or stablecoin launch.
          </p>
          <p style={{ fontSize: 13, color: '#444', lineHeight: 1.8, marginBottom: 16 }}>
            <strong>Communications Consent:</strong> By opting in you consent to be contacted by IVT MEDIA GROUP via phone, email, and/or text message regarding Iron Vault Token presale opportunities, royalty programs, and related services. You may opt out at any time by replying STOP to text messages or contacting us directly.
          </p>
          <p style={{ fontSize: 13, color: '#444', lineHeight: 1.8, marginBottom: 16 }}>
            <strong>Accepted Payments:</strong> IVT MEDIA GROUP only accepts payment via Cash App, Venmo, Zelle, Cryptocurrency, or Cashier&apos;s Check. We will never ask for payment through any other method.
          </p>
          <p style={{ fontSize: 13, color: '#444', lineHeight: 1.8 }}>
