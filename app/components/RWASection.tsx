      ...
      <div className="two-col-grid" style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 50, alignItems: 'center' }}>
        ...
        <div>
          ...
          <p style={{ fontSize: 13, color: '#333', lineHeight: 1.7, marginBottom: 12, textAlign: 'center' }}>
            A core objective of the IVT MEDIA GROUP roadmap is the creation of a <strong>stable digital asset backed by real-world holdings</strong>. As commercial real estate assets are accumulated and stabilized, the project plans to launch a <strong>sister stablecoin</strong> designed to be supported by the underlying value of those commercial properties and other operational assets within the ecosystem.
          </p>
          <p style={{ fontSize: 13, color: '#333', lineHeight: 1.7, marginBottom: 12, textAlign: 'center' }}>
