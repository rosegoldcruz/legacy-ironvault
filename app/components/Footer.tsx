        ...
        <div className="footer-social" style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
          {[
            ...
            <a
              key={s.label}
              href="#"
              style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, textDecoration: 'none', color: '#888', fontSize: 11, fontFamily: 'Montserrat, sans-serif', minHeight: 44, justifyContent: 'center' }}
            >
